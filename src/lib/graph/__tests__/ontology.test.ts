...
// Phase 43: shaped_by + precedes (Option A), anchors (Wave 1), extends (Map Growth Queue) are VALID.
const invalidEdgeTypes = ['invalid', 'RELATES_TO', 'links_to', '', 'anchors_to', 'extended_by']
...
assert(GRAPH_EDGE_TYPES.length === 33, `Edge types count is 33 (got ${GRAPH_EDGE_TYPES.length})`)
