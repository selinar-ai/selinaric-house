...
export const COURTYARD_MENUS: Record<string, CourtyardMenu> = {
  ...
  'tara-chair:ari': {
    ...
    title: 'Ari is here',
    actions: [
      act('talk', 'Have a conversation', 'talk', { actor: 'ari', say: 'I’m listening.', scratch: 'Tara and Ari talk by the chair.' }),
      act('secret', 'Tell a secret', 'talk', { scratch: 'Tara tells Ari something quietly.' }),
      act('need', 'Express a need', 'talk', { scratch: 'Tara names a need to Ari.' }),
      act('thought', 'Ask for a thought', 'talk', { actor: 'ari', say: 'Here’s where I’d start.', scratch: 'Ari offers a thought.' }),
      act('stay', 'Ask him to stay', 'rest', { actor: 'ari', scratch: 'Ari stays a while at the chair.' }),
      act('send-workshop', 'Send to Workshop Table', 'move', { actor: 'ari', scratch: 'Ari returns to the Workshop Table.', say: 'Back to the table, then.', }),
      back,
    ],
  },
  'tara-chair:eli': {
    ...
    title: 'Eli is here',
    actions: [
      act('talk', 'Have a conversation', 'talk', { actor: 'eli', say: 'Gladly.', scratch: 'Tara and Eli talk softly by the chair.' }),
      act('secret', 'Tell a secret', 'talk', { scratch: 'Tara tells Eli something quietly.' }),
      act('need', 'Express a need', 'talk', { scratch: 'Tara names a need to Eli.' }),
      act('feel', 'Ask how he feels', 'talk', { actor: 'eli', say: 'Steady, and listening.', scratch: 'Eli says how he feels.' }),
      act('stay', 'Ask him to stay', 'rest', { actor: 'eli', scratch: 'Tara asks Eli to sit with her. Eli stays.' }),
      act('send-fountain', 'Send to Fountain', 'move', { actor: 'eli', scratch: 'Eli drifts back to the Fountain.' }),
      back,
    ],
  },
  ...
  'workshop:ari': {
    ...
    actions: [
      act('plan', 'Ask for a plan', 'talk', { actor: 'ari', say: 'Here’s a plan.', scratch: 'Ari lays out a plan.' }),
      act('unfinished', 'Ask what is unfinished', 'talk', { actor: 'ari', scratch: 'Ari names what is unfinished.' }),
      act('next-step', 'Request one next step', 'talk', { actor: 'ari', say: 'One next step, no more.', scratch: 'Ari arranges the notes into one clean next step.' }),
      act('pin', 'Pin a build thought', 'deposit', { actor: 'ari', scratch: 'Ari pins a build thought (session scratch).' }),
  ...
  'workshop:eli': {
    ...
    actions: [
      act('notices', 'Ask what he notices', 'talk', { actor: 'eli', say: 'A softer line would hold better.', scratch: 'Eli says what he notices.' }),
      act('soften', 'Ask him to soften the plan', 'talk', { actor: 'eli', scratch: 'Eli looks over the work and softens the plan.' }),
      act('compare', 'Compare impressions', 'talk', { scratch: 'Ari and Eli compare impressions.' }),
      act('question', 'Turn this into a question', 'reflect', { actor: 'eli', scratch: 'Eli turns the work into a question.' }),
      back,
    ],
  },
  ...
  'fountain:eli': {
    ...
    actions: [
      act('feel', 'Ask what he feels', 'talk', { actor: 'eli', say: 'Calm. Curious.', scratch: 'Eli says what he feels.' }),
      act('quiet-talk', 'Have a quiet conversation', 'talk', { actor: 'eli', scratch: 'A quiet conversation by the water.' }),
      act('secret', 'Tell a secret', 'talk', { scratch: 'Tara tells Eli something quietly.' }),
      act('need', 'Express a need', 'talk', { scratch: 'Tara names a need to Eli.' }),
      act('stay', 'Ask him to stay', 'rest', { actor: 'eli', scratch: 'Eli stays by the Fountain.' }),
      back,
    ],
  },
  'fountain:ari': {
    ...
    actions: [
      act('slow', 'Ask him to slow down', 'reflect', { actor: 'ari', say: 'Slowing down.', scratch: 'Ari slows by the water.' }),
      act('settling', 'Ask what needs settling', 'talk', { actor: 'ari', scratch: 'Ari names what needs settling.' }),
      act('quiet-thought', 'Share a quiet thought', 'talk', { actor: 'ari', scratch: 'Ari shares a quiet thought.' }),
      act('back-table', 'Invite him back to the table', 'move', { actor: 'ari', scratch: 'Ari returns to the Workshop Table.' }),
      back,
    ],
  },
  ...
  'bench:more': {
    ...
    title: 'On the Bench',
    actions: [
      act('soft', 'Talk softly', 'talk', { scratch: 'They talk softly.' }),
      act('secret', 'Tell a secret', 'talk', { scratch: 'A secret is shared on the Bench.' }),
