/**
 * Phase 41.17.1 — Manual Library Documentation Helper Runner (pure logic)
 *
 * The deterministic, testable core of the manual CLI runner for the v1
 * `library_documentation_helper`. PURE: no I/O, no DB, no Supabase, no fetch, no
 * Anthropic/OpenAI. The CLI (`scripts/run-library-documentation-helper.ts`)
...
export const LIBRARY_DOCUMENTATION_HELPER_VERSION = '41.17.0'
...
export function dedupeKeyForDraft(
  ...
  helperVersion: string = LIBRARY_DOCUMENTATION_HELPER_VERSION,
): string {
