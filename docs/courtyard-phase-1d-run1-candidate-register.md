...
> **Status this run: 0 candidates sourced** (asset generation/downloading is a manual human step the assistant cannot perform — see `courtyard-phase-1d-run1-log.md` §5).
...
|---|---|---|---|---|---|---|---|---|
| ari-run1-candidate-01 | — | — | — | — | not tested | — | — | — pending |
...
### Run 1 tally
| Character | Sourced | Blocked | Rejected | Needs revision | Visual candidate |
|---|---|---|---|---|---|
| Ari | 0 | 0 | 0 | 0 | 0 |
| Eli | 0 | 0 | 0 | 0 | 0 |
| Tara | 0 | 0 | 0 | 0 | 0 |
