# Eli — Run 1 — Candidate 01 — Provenance Record
...
```text
Candidate ID: eli-run1-candidate-01
Character: Eli
Variant / round: Run 1 Candidate 01
Date acquired/generated: 2026-06-24
...
| 4 | Texture readability | pending preview |
| 5 | Pose suitability | pending Blender inspect (Meshy: neutral standing) |
| 6 | Technical cleanliness | **Concern** — ~45.25 MB / ~1.13M tris, well over budget → decimation needed |
| 7 | Viewer performance | at-risk (very heavy; verify in lab) |
